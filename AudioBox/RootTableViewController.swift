...
class RootTableViewController: UITableViewController {
    enum Functions: String {
        ...
        case AudioMagician = "Audio Magician"
        case AudioSpectrum = "Audio Spectrum"
        case CreateAudio = "Create Audio"
    }
    
    let funcsList: Array<Functions> = [.PCM, .PCMResample, .AudioEncoder, .AudioDecoder, .EarsBack, .AudioMagician, .AudioSpectrum, .CreateAudio]
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case .AudioMagician:
            viewCtr = AudioChangeViewController(nibName: "AudioChangeViewController", bundle: nil)
        case .AudioSpectrum:
